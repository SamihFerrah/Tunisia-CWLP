...
local Index_ALL 	lab_market_main /*lab_market_sec*/ eco_welfare 										///
					assets credit_access pos_coping_mechanisms neg_coping_mechanisms					///
					shocks social civic well_being woman_bargain woman_violence 		
					
local primary 		lab_market_main /*lab_market_sec*/ eco_welfare 										///
					assets credit_access pos_coping_mechanisms neg_coping_mechanisms					///
					shocks
...
local outcomes_number: word count in local (Index_All)
...
file open Table using "Table_Index_nofe.tex", text write replace
...
file open Table using "Table_Index_fe.tex", text write replace
...
********************************************************************************
********************************************************************************
* 3) Main table with three different specification (controlling for number of project per delegation)
********************************************************************************
********************************************************************************	
...
use "$stata/enquete_All3", clear 
		...
		* Between 
			...
			eststo between: regress B_f_`outcome' beneficiaire `ctrl_Aa' num_projects i.strata if between == 1, vce (cluster imada)
		...
		* Within 
			...
			eststo within: regres W_f_`outcome' programs `ctrl_Ba' num_projects i.strata if within == 1, robust
		...
		* Spillovers indiviual level 
			...
			eststo spill1: regres S_f_`outcome' beneficiaire `ctrl_Cb' num_projects i.strata if spillovers == 1, vce (cluster imada)
		...
		* Spillovers imada level  
			...
			eststo spill1: regres I_f_`outcome' beneficiaire `ctrl_Cb' num_projects i.strata if infrastructure == 1, vce (cluster imada)
...
file open Table using "Table_Index_num_project.tex", text write replace
...
use "$stata/enquete_All3", clear 
		...
		* Full 
			...
			regress F_f_`outcome' beneficiaire programs `ctrl_Cb' i.strata if full == 1, vce (cluster imada)
...
file open Table using "Table_Index_Full_nofe.tex", text write replace
...
file open Table using "Table_Index_Full_fe.tex", text write replace
...
********************************************************************************
********************************************************************************
* 3) Main table with full specification (controlling for number of project per delegation)
********************************************************************************
********************************************************************************	
local  count_pvalue = 1
...
file open Table using "Table_Index_Full_num_project.tex", text write replace
